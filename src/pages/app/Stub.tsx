    ...
    <div className="max-w-[1400px] space-y-6">
      ...
      <div className="rounded-2xl border border-dashed border-border bg-card p-12 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-1 max-w-md mx-auto">
          Esta sección forma parte del shell completo de Walix.ai. La UI y los datos
          mock se conectarán en próximas iteraciones.
        </p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {[1,2,3,4,5,6].map((i) => (
          <div key={i} className="rounded-xl border border-border bg-card p-4 shadow-card hover:shadow-card-hover transition-all">
